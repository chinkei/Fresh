...
namespace ProfilerToolbarTest\Collector;

use FlightPath\Configurator\Bootstrap;
use ProfilerToolbar\Collector\XhprofCollector;
use ProfilerToolbar\Options;
...
class XhprofCollectorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $collector = Bootstrap::getServiceManager()->get('ProfilerToolbar\ProfilerCollector');

        $this->assertInstanceOf('ProfilerToolbar\Collector\XhprofCollector', $collector);
    }
}